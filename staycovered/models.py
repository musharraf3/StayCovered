...
class Decision(str, Enum):
    LIKELY_EXEMPT = "likely_exempt"          # an exemption applies — claim it, stop counting hours
    READY_TO_SUBMIT = "ready_to_submit"      # hours met and every claim is evidenced
    ACTION_NEEDED = "action_needed"          # a gap exists — specific documents/hours, with a deadline
    REFER_NAVIGATOR = "refer_navigator"      # complex, conflicting, or time-critical — human help now
